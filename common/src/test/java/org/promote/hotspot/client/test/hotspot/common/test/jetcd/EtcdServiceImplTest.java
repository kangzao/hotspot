package org.promote.hotspot.client.test.hotspot.common.test.jetcd;
...
public class EtcdServiceImplTest {
    ...
    private static EtcdService etcdService = new EtcdServiceImpl("http://127.0.0.1:2379");
